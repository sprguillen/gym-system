    ...
    <div class="col-md-12">
        ...
        <div class="float-right">
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control form-control-sm" value="<?php echo date('Y-m-d', time()); ?>" aria-label="Search for members..." aria-describedby="basic-addon2">
                <div class="input-group-append">
                    <button class="btn btn-outline-primary btn-sm" type="button"><i class="fa fa-search"></i> Select a date</button>
                </div>
            </div>
        </div>
