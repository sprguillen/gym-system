...
<div class="position-relative overflow-hidden px-5 list-page-body">
    ...
    <div class="col-md-12">
        ...
        <div class="btn-group float-right tbl-view" role="group" aria-label="Basic example">
...
<script type="text/javascript">
    ...
    function showReportsBarChart(data, displayType) {
      ...
      data['result'].forEach(function (item) {
        let day = parseInt(item['payment_date_time'].split(' ')[0].split('-')[2])
    ...
    $(document).ready(function () {
        ...
        $('select[name="month"]').on('click', function (e) {
          e.preventDefault()
        ...
        $('select[name="date_view"]').on('change', function (e) {
            ...
            console.log($('select[name="date_view"] :selected').val())
        })
    })
